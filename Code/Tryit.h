...
// Fri May 27 14:23:58 2022 by ROOT version 5.34/30
...
#ifdef Tryit_cxx
Tryit::Tryit(TTree *tree) : fChain(0)
{
...
Int_t Tryit::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Tryit::LoadTree(Long64_t entry)
{
...
void Tryit::Show(Long64_t entry)
{
...
Int_t Tryit::Cut(Long64_t entry)
{
