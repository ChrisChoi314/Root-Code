...
// Tue Jun 14 13:51:12 2022 by ROOT version 5.34/30
...
#ifdef GaussTest_cxx
GaussTest::GaussTest(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../radb.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../radb.root");
      }
...
Int_t GaussTest::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GaussTest::LoadTree(Long64_t entry)
{
...
void GaussTest::Init(TTree *tree)
{
...
void GaussTest::Show(Long64_t entry)
{
...
Int_t GaussTest::Cut(Long64_t entry)
{
