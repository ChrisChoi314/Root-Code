...
// Fri Jun  3 17:06:57 2022 by ROOT version 5.34/30
// from TTree track/dE/dx information
// found on file: /mnt/data/radb_sproc_lowadc.root
//////////////////////////////////////////////////////////
...
#ifdef Histobook_cxx
Histobook::Histobook(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/mnt/data/radb_sproc_lowadc.root");
      if (!f || !f->IsOpen()) {
...
Int_t Histobook::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Histobook::LoadTree(Long64_t entry)
{
...
void Histobook::Init(TTree *tree)
{
...
void Histobook::Show(Long64_t entry)
{
...
Int_t Histobook::Cut(Long64_t entry)
{
