...
public :
   ...
   DedxDriftCell*    MakeCell(int idx, double Radius,double r_down, double r_up);
};
...
DedxDriftCell* PathLength::MakeCell(int idx, double Radius,double r_down, double r_up) {
   Double_t CDCinfo[] = {
      ...
      224,Radius,r_down,r_up,0.7703, //orig is 54.92,0.91,0.91,0.7703,
